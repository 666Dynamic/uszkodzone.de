...
export const metadata: Metadata = {
  ...
  keywords: 'samochody powypadkowe z niemiec, auta powypadkowe niemcy, import aut z niemiec, restwertbörsen, aukcje samochodów niemcy, uszkodzone auto z niemiec, 130%-regelung, giełdy ubezpieczeniowe niemcy, auta uszkodzone niemcy, samochody z niemiec tanie',
